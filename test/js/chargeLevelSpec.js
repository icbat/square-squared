describe("Charge levels", function() {
    it("should return 3 with the highest level", function() {
        expect(chargeLevel(constants.chargeLevels[3], 100)).toBe(3);
        expect(chargeLevel(constants.chargeLevels[3] + 1, 100)).toBe(3);
    });
    ...
    it("should return 0 at 0", function() {
      expect(chargeLevel(0, 100)).toBe(1);
    });

    it("should return 3 at 100%", function() {
      expect(chargeLevel(100, 100)).toBe(3);
    });
